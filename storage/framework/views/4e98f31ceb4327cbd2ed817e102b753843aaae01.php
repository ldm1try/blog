            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e($item->published_at); ?>" class="form-control" disabled>
                    </div>
                </div>
            </div>
        </div>
    </div>
<?php endif; ?><?php /**PATH C:\OSPanel\domains\localhost\blog\resources\views/admin/blog/posts/includes/post_create_add_col.blade.php ENDPATH**/ ?>